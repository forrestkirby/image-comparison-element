...
Copyright (C) 2007–2021 YOOtheme GmbH yootheme.com, 2020–2021 forrestkirby github.com/forrestkirby
...
- copy the complete folder `hd-image-comparison` into the directory `/templates/yootheme_child/builder/` (Joomla!) or `/wp-content/themes/yootheme-child/builder/` (WordPress) of your installation while *child* must be the name of your child theme
- access the YOOtheme Pro Page Builder, the custom elements should now be available

## Issues

Please report issues using the [Github issue tool](https://github.com/forrestkirby/image-comparison-element/issues).

## About

Image Comparison Element is a custom element for YOOtheme Pro developed by [YOOtheme](https://yootheme.com).
...
![](https://herzog-dupont.de/images/tutorials/tutorial-image-comparison-2.jpg)

![](https://herzog-dupont.de/images/tutorials/tutorial-image-comparison-3.jpg)
